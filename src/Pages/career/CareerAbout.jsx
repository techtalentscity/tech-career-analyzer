        ...
        <div className="container mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/about" className="text-lime-600 font-medium transition-colors border-b-2 border-lime-600">About</Link>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-3 pb-3 border-t border-gray-200">
              <div className="flex flex-col space-y-3 mt-3">
                <Link to="/" className="text-gray-700 hover:text-lime-600 font-medium transition-colors">Home</Link>
                <Link to="/about" className="text-lime-600 font-medium transition-colors">About</Link>
                <Link to="/contact" className="text-gray-700 hover:text-lime-600 font-medium transition-colors">Contact</Link>
      ...
      <main className="flex-grow pt-16">
        <div className="container mx-auto px-6 py-12 max-w-5xl">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
              <div className="prose max-w-none">
                ...
                <p className="text-lg text-gray-700">
                  This shift led to the launch of initiatives such as <em className="text-lime-600 font-medium">Career Path in Tech</em>, which helps individuals start or transition into tech careers, and <em className="text-lime-600 font-medium">Grow Your Career in Tech</em>, which offers targeted, self-paced learning tailored to specific interests and skill development. These programs have empowered many to gain in-demand skills and build successful careers in the tech industry.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16 grid md:grid-cols-2 gap-8">
            {/* Mission */}
            <div className="bg-gradient-to-br from-lime-50 to-green-50 rounded-2xl shadow-md p-8">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-lime-600 rounded-full flex items-center justify-center text-white text-2xl mr-4">
                  🎯
                </div>
            ...
            {/* Vision */}
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl shadow-md p-8 flex flex-col justify-between">
              <div>
                <div className="flex items-center mb-6">
              ...
              <div className="mt-6 bg-white/50 p-4 rounded-lg border border-green-100">
              ...
              <div className="p-6 md:p-10">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-lime-50 p-6 rounded-xl">
                    <div className="text-3xl text-lime-600 mb-3">🤖</div>
                  ...
                  <div className="bg-green-50 p-6 rounded-xl">
                    <div className="text-3xl text-green-600 mb-3">🗺️</div>
                ...
                <div className="mt-8 bg-gradient-to-r from-lime-50 to-green-50 p-6 rounded-xl">
                ...
                <div className="mt-8 text-center">
                  ...
                  <Link to="/" className="mt-6 inline-block bg-gradient-to-r from-lime-500 to-green-600 text-white px-8 py-3 rounded-full font-semibold text-lg hover:from-lime-600 hover:to-green-700 transform hover:scale-105 transition-all duration-300 shadow-lg">
